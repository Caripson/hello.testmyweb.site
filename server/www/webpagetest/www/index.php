...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        <title>Free tool for web performance and optimization</title>
        <?php $gaTemplate = 'Main'; include ('head.inc'); ?>
   	<script src='https://www.google.com/recaptcha/api.js?render=6Ldek30UAAAAABT7qyBiQ2AaHp0wGaYNJCea_bRx'></script>
	<script src="/jquery-3.3.1.min.js"></script>
<script>
$(document).ready(function(){
   //Hover fix iOS
  $(".rounded-btn").hover(function(){
...
<div class="page">
            ...
            <h2 class="cufon-dincond_black">Test your website</h2>
            ...
            <div id="test_box-container">
                ...
                <div id="analytical-review" class="test_box">
                   ...
                   <?php
                    ...
                    {
                        echo '<p><a href="javascript:void(0)" id="advanced_settings" class="extended">Advanced Settings </a><small id="settings_summary_label" class="hidden"><br><span id="settings_summary"></span></small></p>';
                        echo '<div id="advanced_settings-container">';
                    }
                    else
                    {
                        echo '<p><a href="javascript:void(0)" id="advanced_settings">Advanced Settings </a><small id="settings_summary_label"><br><span id="settings_summary"></span></small></p>';
					...
					<label for="stop_test_at_document_complete" class="auto_width">
                                            Stop Test at Document Complete - <i>(Typically, tests run until all activity stops.)</i>
                                        </label>
					<span class="checkmark"></span>
                                        </label>
                                    </li>
					...
					<label for="noscript" class="auto_width">
					 ...
					 <label class="container">
                                        ...
                                        <label for="clearcerts" class="auto_width">
                                            Clear SSL Certificate Caches - <i>(Internet Explorer and Chrome)</i>
                                        </label>
					 <span class="checkmark"></span>
                                        </label>
                                    </li>
					 ...
					 <label class="container">
                                        ...
                                        <label for="ignore_ssl_cerificate_errors" class="auto_width">
                                            Ignore SSL Certificate Errors - <i>(e.g. Name mismatch, Self-signed certificates, etc.)</i>
                                        </label>
					 <span class="checkmark"></span>
                                        </label>
                                    </li>
					 ...
					 <label class="container">
                                        ...
                                        <label for="force_standards_mode" class="auto_width">
                                            Disable Compatibility View (IE Only) - <i>(Forces all pages to load in standards mode)</i>
                                        </label>
					 <span class="checkmark"></span>
                                        </label>
                                    </li>
					 ...
					 <label class="container">
                                        ...
                                        <label for="tcpdump" class="auto_width">
                                            Capture network packet trace - <i>(tcpdump)</i>
                                        </label>
					 <span class="checkmark"></span>
                                        </label>
                                    </li>
					 ...
					 <label class="container">
                                        ...
                                        <label for="bodies" class="auto_width">
                                            Save response bodies - <i>(For text resources)</i>
                                        </label>
					 <span class="checkmark"></span>
                                        </label>
                                    </li>
					 ...
					 <label class="container">
                                        ...
                                        <label for="keepua" class="auto_width">
                                            Preserve original User Agent string - <i>(Do not add PTST to the browser UA string)</i>
                                        </label>
					 <span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        ...
                                        User Agent String - <i>(Custom UA String)</i>
                                        </label>
                                        <input type="text" name="uastring" id="uastring" class="text" style="width: 250px;">
                                    </li>
                                    <?php
					...
					<label class="container">
                                        ...
                                        <label for="full_size_video" class="auto_width">
                                            Capture Full Size Video - <i>(Enables full size screenshots in the filmstrip)</i>
                                        </label>
				     ...
				     <span class="checkmark"></span>
                                    ...
                                    <li>
                                        ...
                                        <input id="time" type="number" class="text short" name="time" value=""><b> seconds</b>
                                    </li>
                                    <li>
                                        <label for="customHeaders">
                                            Custom headers<br>
				<div class="font-size:2px">Add custom headers to all network requests emitted from the browser</div>
                                        </label>
                                    ...
                                    <li>
                                        <label for="injectScript">
                                            Inject Script<br>
                                            <div class="font-size:2px">JavaScript to run after the document has started loading</div>
                                        </label>
					...
					<span class="checkmark"></span></label>
                                    ...
                                    <li><label class="container">
                                        ...
                                        <label for="dataReduction" class="auto_width">
                                            Enable Data Reduction - <i>Chrome 34+ on Android</i>
                                        </label>
					 <span class="checkmark"></span></label>
                                    </li>
                                    <?php
                                ...
                                <div>
                                    <div class="notification-container">
                                        <div class="notification"><div class="message">
                                            Check out <a href="https://sites.google.com/a/webpagetest.org/docs/using-webpagetest/scripting?site=hello.testmyweb.site">the documentation</a> for more information on this feature
                                        </div></div>
                                    </div>
					...
					<label class="container">
                                        ...
                                        <label for="sensitive" class="auto_width">
                                            Script includes sensitive data  - <i>(The script will be discarded and the HTTP headers)</i>
                                        </label>
					 <span class="checkmark"></span></label>
                                    </li>
                                    <li>
					 ...
					 <span class="checkmark"></span></label>
                            ...
                            <div id="custom-metrics" class="test_subbox ui-tabs-hide">
                                <div>
                                    <div class="notification-container">
                                        <div class="notification"><div class="message">
                                            See <a href="https://sites.google.com/a/webpagetest.org/docs/using-webpagetest/custom-metrics?site=hello.testmyweb.site">the documentation</a> for details on how to specify custom metrics to be captured.
                                        </div></div>
                                    </div>
                                    ...
                                    <div class="notification-container">
                                        <br>
                                        <div class="notification"><div class="message">
                                            See <a href="https://github.com/WPO-Foundation/webpagetest/blob/master/docs/Metrics/HeroElements.md?site=hello.testmyweb.site">the documentation</a> for details on how to specify custom hero elements.
                                        </div></div>
                                    </div>
 ...
 <?php
                if (strlen($siteKey)) {
                  ...
                  echo '<p><input type="submit" name="submit" value="Start Test" class="rounded-btn"></p>';
                }
                ?>
        ...
        <script type="text/javascript" src="<?php echo $GLOBALS['cdnPath']; ?>/js/test.js"></script>
