...
$page_keywords = array('hello','test','my','website','Video','comparison','Webpagetest','Website Speed Test');
    ...
    <body>
        <div class="page">
            ...
            <div id="test_box-container">
                        ...
                        <div id="urls">
                            ...
                            if( $tid )
                            {
                                ...
                                if( strlen($url) )
                                {
                                    ...
                                    echo "URL: <input id=\"tidurl\" type=\"text\" style=\"width:370px\" value=\"$url\" disabled=\"disabled\"> ";
				...
				URL: <input id="url1" type="text" name="url[1]" style="width:370px" onkeypress="if (event.keyCode == 32) {return false;}" > 
                                <a href='#' onClick='return RemoveUrl("#urldiv1");'>Remove</a>
                            </div>
                        </div>
                        <br>
                        <button class="rounded-btn" onclick="return AddUrl();">Add</button> another page to the comparison.
                        <br>
                        <ul>
                        <?php
