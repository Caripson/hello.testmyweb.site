...
function ScreenShotTable()
{
    ...
    if( count($tests) )
    {
        ...
        echo "</div>";
        echo '<div id="bottom"><label class="container">Slow Motion<input type="checkbox" name="slow" value="1"><span class="checkmark"></span>
</label><br><br>';
        echo "<input id=\"SubmitBtn\" type=\"submit\" value=\"Create Video\" class=\"rounded-btn\">";
            ...
            ?>
                <table id="layoutTable" >
                    ...
                    <?php
                        ...
                        echo "<label class=\"container\">Small<input type=\"radio\" name=\"thumbSize\" value=\"100\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( $thumbSize <= 150 && $thumbSize > 100 )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">Medium<input type=\"radio\" name=\"thumbSize\" value=\"150\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( $thumbSize > 150 )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">Large<input type=\"radio\" name=\"thumbSize\" value=\"200\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        echo "</td>";
                        ...
                        if ($supports60fps) {
                          ...
                          if( $interval < 100 )
                              $checked = ' checked=checked';
                          echo "<label class=\"container\">60 FPS<input type=\"radio\" name=\"ival\" value=\"16.67\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        }
                        $checked = '';
                        if( ($supports60fps && $interval == 100) || (!$supports60fps && $interval < 500) )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">0.1 sec<input type=\"radio\" name=\"ival\" value=\"100\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( $interval == 500 )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">0.5 sec<input type=\"radio\" name=\"ival\" value=\"500\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( $interval == 1000 )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">1 sec<input type=\"radio\" name=\"ival\" value=\"1000\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( $interval > 1000 )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">5 sec<input type=\"radio\" name=\"ival\" value=\"5000\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        echo "</td>";
                        ...
                        if( !strcasecmp($endTime, 'visual') )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">Visually Complete<input type=\"radio\" name=\"end\" value=\"visual\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( !strcasecmp($endTime, 'all') )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">Last Change<input type=\"radio\" name=\"end\" value=\"all\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( !strcasecmp($endTime, 'doc') )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">Document Complete<input type=\"radio\" name=\"end\" value=\"doc\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        $checked = '';
                        if( !strcasecmp($endTime, 'full') )
                            $checked = ' checked=checked';
                        echo "<label class=\"container\">Fully Loaded<input type=\"radio\" name=\"end\" value=\"full\"$checked onclick=\"this.form.submit();\"><span class=\"checkmark\"></span></label>";
                        echo "</td></tr>";
                    ?>
                </table>
            </form>
