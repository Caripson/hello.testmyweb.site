...
$page_description = "History of website performance speed tests run on hello.testmyweb.site.";
...
$(document).ready(function(){
  ...
  $(".rounded-btn").hover(function(){
	...
	<h2 class="cufon-dincond_black">Compare test data</h2>    
	<div class="translucent">
			...
			<?php
				...
				<label class="container">
                               	<div style="position:relative; top:8px;"> Show tests from all users</div>
				<input type="checkbox" id="all" name="all" <?php check_it($all);?> onclick="this.form.submit();">
			...
			<label class="container">
  			 <div style="position:relative; top:8px;">Only list tests that include video</div>
			<input type="checkbox" id="video" name="video" <?php check_it($onlyVideo);?> onclick="this.form.submit();">
			<span class="checkmark"></span>
			</label>
			 ...
			 <label class="container">
                         <div style="position:relative; top:8px;">Do not limit the number of results (warning, WILL be slow)</div>
                        <input type="checkbox" id="nolimit" name="nolimit"  <?php check_it($nolimit);?> onclick="this.form.submit();" >
                        <span class="checkmark"></span>
                        </label>
		<br>
		<br>
		<input id="SubmitBtn" type="submit" value="Update List" class="rounded-btn">		
                </form>
...
<th style="text-decoration: none;" ><input id="CompareBtn" type="submit" value="Compare" class="rounded-btn"></th>
                </form>
            </div>
