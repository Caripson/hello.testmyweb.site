...
$page_keywords = array('hello','test','my','website','Traceroute','Webpagetest','Website Speed Test','Test');
$page_description = "Test network path from multiple locations around the world (traceroute).";
?>
<!DOCTYPE html>
<html>
    <head>
        <title>Traceroute diagnostic</title>
  ...
  $(".rounded-btn").hover(function(){
    ...
    <body>
        ...
        //      echo "<script src=\"https://www.google.com/recaptcha/api.js\" async defer></script>\n";
            ...
            <h2 class="cufon-dincond_black">ICMP traceroute from one of the test agents....</h2>
